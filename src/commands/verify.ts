/**
 * specgraph — Verify/explain/find/waivers/subject CLI commands.
 */
...
import type {
  SpecVerificationResult, PolicyResultStatus, RunSummary,
  PolicyResult, Claim, Waiver,
} from '../types.js';
...
export function registerV2Commands(program: Command): void {
  ...
  program
    .command('verify')
    .description('Run specgraph verification: collect claims, evaluate policy')
